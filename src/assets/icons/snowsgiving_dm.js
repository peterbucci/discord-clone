...
export default function SnowsgivingDMIcon({ selected }) {
  const themeContext = useContext(ThemeContext);
  return (
    <SvgIcon selected={selected} width="48px" height="48px" viewBox="0 0 48 48">
      <SvgIcon.Group style={{ transition: "fill 150ms ease-out 0s" }}>
        <SvgIcon.Path
        ...
        <SvgIcon.Path
          fill={themeContext.white}
          d="M20.82,6.14a.89.89,0,1,0-.89-.89A.89.89,0,0,0,20.82,6.14Z"
        ></SvgIcon.Path>
        <SvgIcon.Path
          fill={themeContext.white}
          d="M4.93,32.06a1,1,0,0,0,0-2,1,1,0,1,0,0,2Z"
        ></SvgIcon.Path>
        <SvgIcon.Path
          fill={themeContext.white}
          d="M11.22,11.72A1.79,1.79,0,1,0,9.44,9.94,1.79,1.79,0,0,0,11.22,11.72Z"
        ></SvgIcon.Path>
        <SvgIcon.Path
          fill={themeContext.white}
          d="M48,38.94V48H0V40.18a17,17,0,0,1,1.55.76c6.49-4.13,10.29-2.65,14.89,0s6.73.84,10.49,0a8.47,8.47,0,0,1,7,1.58C37.32,39.81,41.71,34.8,48,38.94Z"
        ></SvgIcon.Path>
      </SvgIcon.Group>
    </SvgIcon>
  );
