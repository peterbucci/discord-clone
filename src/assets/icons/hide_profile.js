...
export default function HideProfileIcon() {
  return (
    <SvgIcon x="0" y="0">
      <SvgIcon.Group fill="none">
        ...
        ></SvgIcon.Path>
        <SvgIcon.Path d="M18 22C20.2091 22 22 20.2091 22 18C22 15.7909 20.2091 14 18 14C15.7909 14 14 15.7909 14 18C14 20.2091 15.7909 22 18 22Z"></SvgIcon.Path>
      </SvgIcon.Group>
    </SvgIcon>
  );
}
